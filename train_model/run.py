...
def extractDataset(sto, target, device, is_ocr=0):
...
def training(model_name, train_data, dev_data, device, num_epochs=100, learning_rate=0.000001, early_stopping_patience=20):
